...
| **Réglages** | `q` quitte l'app sélectionnée (façon commutateur de fenêtres) · `,` préférences · Cmd-Q / menu pour quitter Tabs · préférences ouvertes au lancement et au clic Dock | ✅ |
